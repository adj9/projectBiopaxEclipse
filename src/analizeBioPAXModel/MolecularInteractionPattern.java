...
/**
 * Classe per implementre il pattern molecularInteraction della libreria biopax-pattern.
 * Questa classe estende {@link ExecutePattern}.
 * 
 * @author Alessandro
 *
 */
public class MolecularInteractionPattern extends ExecutePattern {
	
	/**
	 * Costruttore di default per caratterizzare il tipo di relazione delle interazioni. 
	 */
	public MolecularInteractionPattern() {
		super(SIFEnum.INTERACTS_WITH.getTag());
	}

	@Override
	public List<Match> executePattern(Model model, String entityName) {		
		return super.executePattern(model, entityName, PatternBox.molecularInteraction(), "Protein 1");
	}
}
